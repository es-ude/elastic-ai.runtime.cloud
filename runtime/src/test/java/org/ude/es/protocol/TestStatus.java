...
public class TestStatus {
    ...
    void testOptionalStatus() {
        ...
        Assertions.assertEquals("ID:ID;TYPE:TYPE;STATE:" + ONLINE + ";key0:value0;key1:value1;", status.get());
    ...
    void testDataStatus() {
        ...
        Assertions.assertEquals("ID:ID;TYPE:TYPE;STATE:" + ONLINE + ";DATA:data0,data1;", status.get());

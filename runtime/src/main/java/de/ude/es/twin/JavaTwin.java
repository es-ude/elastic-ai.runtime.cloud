...
public class JavaTwin extends Twin {
    ...
    public void publishStatus ( String who, boolean online ) {
        this.publish( Posting.createStatus( who, online ) );
    }

    public void subscribeForDataStartRequest ( String dataId,
    ...
    public void subscribeForDataStopRequest ( String dataId,
                                              Subscriber subscriber ) {

...
public class TestClientData {
    ...
    void setUp() {
        ...
        clientData.updateValues("TYPE:" + CLIENT_TYPE + ";STATE:" + CLIENT_ACTIVE + ";DATA:" + CLIENT_DATA + ";" + CLIENT_OPTIONAL);
    }
    ...
    void testToString() {
        String expectedResult =
                "ClientData{" +
                        ...
                        ", ID='" + CLIENT_ID + '\'' +
                        ", type='" + CLIENT_TYPE + '\'' +
                        ", active=" +  Objects.equals(CLIENT_ACTIVE, "ONLINE") +
                        ", dataValues=" + Arrays.toString(CLIENT_DATA.split(",")) +
                        ", optionalValues=" + CLIENT_OPTIONAL_VALUES +
                        ", dataValue=" + CLIENT_LAST_DATA_VALUES +
                        '}';

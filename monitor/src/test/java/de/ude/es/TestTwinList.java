...
public class TestTwinList {
    ...
    void testChangeTwinName () {
        ...
        List <TwinData> expected = List.of( new TwinData( "Twin_0_new_name",
                                                          "ID0" ),
                                            new TwinData( "Twin 1", "ID1" ),
                                            new TwinData( "Twin_2_new_name",
                                                          "ID2" ) );
    ...
    @Test
    void testGetTwin () {
        assertEquals( new TwinData( "Twin 1", "ID1" ).toString( ),
    ...
    @Test
    void testAddTwin () {
        List <TwinData> expected = List.of( new TwinData( "Twin 0", "ID0" ),
                                            new TwinData( "Twin 1", "ID1" ),
        ...
        expected = List.of( new TwinData( "Twin 0", "ID0" ),
                            new TwinData( "Twin 1", "ID1" ),
                            new TwinData( "Twin 2", "ID2" ),
    ...
    void testGetActiveTwins () {
        ...
        twins.add( new TwinData( "Twin 0", "ID0" ) );
        twins.add( new TwinData( "Twin 1", "ID1" ) );
        twins.add( new TwinData( "Twin 2", "ID2" ) );
        twinList.getTwins( ).add( new TwinData( "Twin 3", "ID3", false ) );

        assertEquals( twins.toString( ),
                      twinList.getActiveTwins( ).toString( ) );
    }
